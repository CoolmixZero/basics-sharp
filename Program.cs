/*Определите метод IsRightTriangle(int a, int b, int c) с тремя целочисленными параметрами, 
 * который возвращает true, если три введенных числовых значения могут представлять длину сторон прямоугольного треугольника. 
